...
import SearchInputCard from '../../../../widgets/SearchInputCard/SearchInputCard';
import RenderSearchInputModal from "../../../../widgets/RenderSearchInputModal/RenderSearchInputModal";
	...
	return (
		<div className={cl.searchInputWrapper}>
			<div className={cl.searchBox}>
				<button className={cl.btnSearch}>
					<svg
						xmlns="http://www.w3.org/2000/svg"
						className={cl.faSearch}
						fill="white"
						height="24"
