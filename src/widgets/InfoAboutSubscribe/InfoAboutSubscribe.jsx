			...
			{isSub ? (
				<div className={cl.infoWrapper}>
					<h1 className={cl.accessText}>
						...
						<br />
						Вам доступны лучшие фильмы и сериалы!
					</h1>
					<MainModal
						onClickCallback={handleToggleActive}
						className={isActive ? cl.active : undefined}
				...
				<div className={cl.infoWrapper1}>
					<h1 className={cl.accessText}>
						Получите доступ ко всем премиум фильмам и сериалам всего за 149₽
					</h1>
					<MainButton onClick={() => handleToggleActive()}>
						Подписаться
					</MainButton>
				</div>
			)}
