...
const MovieContent = ({ movieData }) => {
	const categories = movieData.categories
		? Object.keys(movieData.categories).join(', ')
		: '';
	...
	return (
		<>
			<div className={cl.contentContainer}>
				{movieData.titleImg ? (
					<img
						className={cl.filmNamgeImg}
						src={movieData.titleImg}
						fetchpriority="high"
						alt="Film-Name"
					/>
				) : (
				...
				<div>{movieData.desc}</div>
				<MainButton className={cl.button}>
					<svg
						width="24"
						height="24"
						viewBox="0 0 24 24"
