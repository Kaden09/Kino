...
const SignInUser = () => {
	...
	return (
		<form
			...
			action=""
			className={cl.container_Registration}>
			<h2 className={cl.h2_Registration__Header}>Вход</h2>
			<MainInput
				onChange={e => setEmail(e.target.value)}
				type="text"
				placeholder="Email"
				className={cl.signInInput}
			/>
			<MainInput
				...
				className={cl.signInInput}
			/>
			<MainButton onClick={handleLogin} className={cl.signInButton}>
				Войти
			</MainButton>
